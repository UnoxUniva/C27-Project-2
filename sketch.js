...
function setup() {
	...
	world = engine.world;
	 ...
	 bob1 = new bob(700,420,50)
	 bob2 = new bob(550,425,50)
	 bob3 = new bob(300,415,50)
   ...
   rope2=new rope(bob2.body, roof2.body,-bobDiameter*0,0)
   rope3=new rope(bob3.body, roof3.body,-bobDiameter*0,0)
   rope4=new rope(bob4.body, roof4.body, -bobDiameter*0,0)
   rope5=new rope(bob5.body, roof5.body, -bobDiameter*0,0)
...
function keyPressed(){
  if(keyCode===37){
    Matter.Body.setVelocity(bob5.body, {x:-10,y:0})
  }
}
